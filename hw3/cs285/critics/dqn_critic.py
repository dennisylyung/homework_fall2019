...
class DQNCritic(BaseCritic):
    ...
    def _build(self, q_func):
        ...
        if self.double_q:
            ...
            q_tp1 = tf.gather(q_tp1_values, tf.math.argmax(self.q_t_values, axis=1), axis=1)
        else:
        ...
        # DONE: calculate the targets for the Bellman error
        ...
        # DONE: compute the Bellman error (i.e. TD error between q_t and target_q_t)
        ...
        # DONE: these variables should all of the
