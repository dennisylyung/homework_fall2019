...
class PGAgent(BaseAgent):
    ...
    def train(self, obs, acs, rews_list, next_obs, terminals):
        ...
        # step 3:
        # DONE: pass the calculated values above into the actor/policy's update,
    ...
    def calculate_q_vals(self, rews_list):
        ...
        if not self.reward_to_go:
            ...
            # DONE: Estimate the Q value Q^{pi}(s_t, a_t) using rewards from that entire trajectory
        ...
        # Case 2: reward-to-go PG 
            ...
            # DONE: Estimate the Q value Q^{pi}(s_t, a_t) as the reward-to-go
    ...
    def estimate_advantage(self, obs, q_values):
        ...
        # DONE: Estimate the advantage when nn_baseline is True
    ...
    def _discounted_return(self, rewards):
        ...
        list_of_discounted_returns = np.full(len(rewards), sum_of_discounted_rewards)
